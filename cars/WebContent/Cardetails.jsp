...
<div class="container">
    <center><h1><font color="white"><b>CAR DETAILS</b></font></h1></center>  
...
String QueryString = "SELECT carid,cartype,rent,vin,cust_email,cust_aadhar,status from rentcar";
